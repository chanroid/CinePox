package com.kr.busan.cw.cinepox.player.base;
...
public interface Constants {
	...
	public static final String SHAKE_DELETE_URL = Domain.ACCESS_DOMAIN
			+ "player/shakeDelete";
	public static final String SHAKE_REQUEST_URL = Domain.ACCESS_DOMAIN
			+ "player/shakeRequest";
	public static final String SHAKE_RESPONSE_URL = Domain.ACCESS_DOMAIN
			+ "player/shakeResponse";
	public static final String SHAKE_GET_KEY_URL = Domain.ACCESS_DOMAIN
			+ "player/shakeGetKey";
