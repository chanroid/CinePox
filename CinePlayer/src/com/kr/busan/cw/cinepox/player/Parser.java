...
public class Parser {
	...
	public static final String URL_GET_CONTENTS = Domain + "player/getContents/";
...
//		HttpGet post = null;
		...
		String movieProduct_seq, member_seq, ad_seq, num, type, msg, state_info, memo, bug_title, bookmark_time, is_public, bookmark_seq, text_banner_seq;
		// String bug_image;
		// String bookmark_image;
		switch (code) {
		case REQ_GET_CONTENTS:
//			post = new HttpPost(URL_GET_CONTENTS);
			post = new HttpPost(URL_GET_CONTENTS);
			movieProduct_seq = params[0];
			member_seq = params[1];
			param.add(new BasicNameValuePair(KEY_MOVIE_NUM,
					movieProduct_seq));
